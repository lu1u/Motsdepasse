/***
 * un gestionnaire de fontes inspir� de UlduzSoft
...
{
private static final String[] fontdirs = { "/system/fonts", "/system/font", "/data/fonts" };
...
static public ArrayList<String> enumerateFontFiles()
{
